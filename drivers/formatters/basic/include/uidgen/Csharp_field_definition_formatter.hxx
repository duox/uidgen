/*Csharp_field_definition_formatter.hxx*/

class UIDGEN_API uidgen::Csharp_field_definition_formatter : public uidgen::Iuser_formatter
{
public:
	typedef uidgen::Iuser_formatter				super;
	typedef Csharp_field_definition_formatter	self;
...
/*END OF Csharp_field_definition_formatter.hxx*/
