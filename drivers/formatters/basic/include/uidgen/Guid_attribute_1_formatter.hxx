/*Guid_attribute_1_formatter.hxx*/

class UIDGEN_API uidgen::Guid_attribute_1_formatter : public uidgen::Iuser_formatter
{
public:
	typedef uidgen::Iuser_formatter			super;
	typedef Guid_attribute_1_formatter		self;
...
/*END OF Guid_attribute_1_formatter.hxx*/
