/*Csharp_Guid_object_formatter.hxx*/

class UIDGEN_API uidgen::Csharp_Guid_object_formatter : public uidgen::Iuser_formatter
{
public:
	typedef uidgen::Iuser_formatter				super;
	typedef Csharp_Guid_object_formatter	self;
...
/*END OF Csharp_Guid_object_formatter.hxx*/
