/*null_uuid_generator.hxx*/

class UIDGEN_API uidgen::null_uuid_generator : public uidgen::Igenerator
{
public:
	typedef uidgen::Igenerator		super;
	typedef null_uuid_generator		self;
...
/*END OF null_uuid_generator.hxx*/
