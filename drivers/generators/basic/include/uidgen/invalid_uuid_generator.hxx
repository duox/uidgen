/*invalid_uuid_generator.hxx*/

class UIDGEN_API uidgen::invalid_uuid_generator : public uidgen::Igenerator
{
public:
	typedef uidgen::Igenerator			super;
	typedef invalid_uuid_generator		self;
...
/*END OF invalid_uuid_generator.hxx*/
